...
from const import BASE_DIR, CSV_DIR_PATH, OUTPUT_DIR_PATH, INVESTMENT_TRUST_NAMES
...
for year in year_range:
    ...
    for name in INVESTMENT_TRUST_NAMES:
        ...
        file_path = CSV_DIR_PATH / name
        csv_file = open(f'{file_path}.csv', encoding='ShiftJIS')
    ...
    del wb['Sheet']
    wb.save(f'{OUTPUT_DIR_PATH / str(year)}_投資信託.xlsx')
